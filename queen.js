...
async function sessdl() {
  try {
    ...
    const base64Data = sess.SESSION_ID.split("MAYA-MD~")[1];
    if (!base64Data) {
...
async function connectToWA() {
  ...
  //===========================
  console.log("🔥 QUEEN MAYA MD is starting...");
  ...
  conn.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      let up = `
          🚀 **© 𝚀𝚄𝙴𝙴𝙽 𝙼𝙰𝚈𝙰 𝙼𝙳 💚 Connected Successfully!** ✅ 
          
          --- **🎉 Welcome to © 𝚀𝚄𝙴𝙴𝙽 𝙼𝙰𝚈𝙰 𝙼𝙳  💚!** 🎉 
          ...
          --- Thank you for using **© 𝚀𝚄𝙴𝙴𝙽 𝙼𝙰𝚈𝙰 𝙼𝙳💚**. 
      ...
      conn.sendMessage(conn.user.id, {
        text: up,
        contextInfo: {
          mentionedJid: ["94716717099@s.whatsapp.net"], // specify mentioned JID(s) if any
          groupMentions: [],
          forwardingScore: 999,
          isForwarded: true,
          forwardedNewsletterMessageInfo: {
            newsletterJid: "120363299978149557@newsletter",
            newsletterName: "© 𝚀𝚄𝙴𝙴𝙽 𝙼𝙰𝚈𝙰 𝙼𝙳 💚",
            serverMessageId: 999,
          },
          externalAdReply: {
            title: "© 𝚀𝚄𝙴𝙴𝙽 𝙼𝙰𝚈𝙰 𝙼𝙳💚",
            body: " ©𝐌𝐑 𝗜𝗦𝗦𝗨 💚",
            mediaType: 1,
            sourceUrl: "https://github.com/issu478/Maya-MD/tree/main",
            thumbnailUrl:
              "https://files.catbox.moe/4bc81k.png", // This should match the image URL provided above
